@extends('layouts.app', ['page' => __('View Editorial KPI'), 'pageSlug' => 'editorialKpi.view'])
...
<table class="table table-striped table-dark">
  <thead>
    ...
    <tr>
        <th scope="col">
            <form method="post" action="{{ route('showMaxIdEditorial') }}">
                @csrf
        ...
        <th scope="col">
            <form method="post" action="{{ route('showMonthlyMaxIdEditorial',['month'=>$month]) }}">
                @csrf
