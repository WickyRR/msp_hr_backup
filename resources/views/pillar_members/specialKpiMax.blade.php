@extends('layouts.app', ['page' => __('View Special Overall Highest KPI'), 'pageSlug' => 'specialkpi.view'])
...
<div>
        ...
        <button><a href="{{ route('specialkpi.view') }}">Go back To KPI Analysis</a></button>
