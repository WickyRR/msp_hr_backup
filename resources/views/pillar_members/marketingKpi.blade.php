@extends('layouts.app', ['page' => __('View Marketing KPI'), 'pageSlug' => 'marketingkpi.view'])
...
<table class="table table-striped table-dark">
  <thead>
    ...
    <tr>
        <th scope="col">
            <form method="post" action="{{ route('showMaxIdMarketing') }}">
                @csrf
        ...
        <th scope="col">
            <form method="post" action="{{ route('showMonthlyMaxIdMarketing',['month'=>$month]) }}">
                @csrf
