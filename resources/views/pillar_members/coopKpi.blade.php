@extends('layouts.app', ['page' => __('View Cooperative KPI'), 'pageSlug' => 'coopkpi.view'])
...
<table class="table table-striped table-dark">
  <thead>
    ...
    <tr>
        <th scope="col">
            <form method="post" action="{{ route('showMaxIdCoop') }}">
                @csrf
        ...
        <th scope="col">
            <form method="post" action="{{ route('showMonthlyMaxIdCoop',['month'=>$month]) }}">
                @csrf
