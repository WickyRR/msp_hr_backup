@extends('layouts.app', ['page' => __('View Editorial Monthly Highest KPI'), 'pageSlug' => 'editorialkpi.view'])
...
<div>
        ...
        <button><a href="{{ route('editorialkpi.view') }}">Go back To KPI Analysis</a></button>
