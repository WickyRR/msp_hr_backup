@extends('layouts.app', ['page' => __('View Video KPI'), 'pageSlug' => 'videokpi.view'])
...
<table class="table table-striped table-dark">
  <thead>
    ...
    <tr>
        <th scope="col">
            <form method="post" action="{{ route('showMaxIdVideo') }}">
                @csrf
        ...
        <th scope="col">
            <form method="post" action="{{ route('showMonthlyMaxIdVideo',['month'=>$month]) }}">
                @csrf
