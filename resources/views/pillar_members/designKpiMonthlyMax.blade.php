@extends('layouts.app', ['page' => __('View Design Monthly Highest KPI'), 'pageSlug' => 'designkpimonthlymax.view'])
...
<div>
        ...
        <button><a href="{{ route('designkpi.view') }}">Go back To KPI Analysis</a></button>
