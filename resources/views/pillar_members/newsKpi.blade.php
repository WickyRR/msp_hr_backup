@extends('layouts.app', ['page' => __('View News KPI'), 'pageSlug' => 'newskpi.view'])
...
<table class="table table-striped table-dark">
  <thead>
    ...
    <tr>
        <th scope="col">
            <form method="post" action="{{ route('showMaxIdNews') }}">
                @csrf
        ...
        <th scope="col">
            <form method="post" action="{{ route('showMonthlyMaxIdNews',['month'=>$month]) }}">
                @csrf
