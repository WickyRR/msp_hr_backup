@extends('layouts.app', ['page' => __('View Special KPI'), 'pageSlug' => 'specialkpi.view'])
...
<table class="table table-striped table-dark">
  <thead>
    ...
    <tr>
        <th scope="col">
            <form method="post" action="{{ route('showMaxIdSpecial') }}">
                @csrf
        ...
        <th scope="col">
            <form method="post" action="{{ route('showMonthlyMaxIdSpecial',['month'=>$month]) }}">
                @csrf
