@extends('layouts.app', ['page' => __('View Web KPI'), 'pageSlug' => 'webkpi.view'])
...
<div>
    ...
    <!-- Assuming $kpis is an object containing the retrieved data -->
{{-- @isset ($kpij)--}}

<!--<p>ID: {{-- $kpis->id --}}</p>
<p>First Name: {{-- $kpis->first_name --}}</p>
<p>Last Name: {{-- $kpis->last_name --}}</p>
<p>Nearest Town: {{-- $kpis->nearest_town --}}</p>
<p>Contact Number: {{-- $kpis->contact_number --}}</p>
<p>Facebook URL: {{-- $kpis->facebook_url --}}</p>
<p>Instagram URL: {{-- $kpis->instagram_url --}}</p>
<p>Birthday: {{-- $kpis->birthday --}}</p>-->
...
<table class="table table-striped table-dark">
  <thead>
    ...
    <tr>
        <th scope="col">
            <form method="post" action="{{ route('showMaxIdWeb') }}">
                @csrf
        ...
        <th scope="col">
            <form method="post" action="{{ route('showMonthlyMaxIdWeb',['month'=>$month]) }}">
                @csrf
