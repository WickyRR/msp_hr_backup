@extends('layouts.app', ['page' => __('View News Monthly Highest KPI'), 'pageSlug' => 'newskpimonthlymax.view'])
...
<div>
        ...
        <button><a href="{{ route('newskpi.view') }}">Go back To KPI Analysis</a></button>
