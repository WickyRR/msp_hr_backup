@extends('layouts.app', ['page' => __('View Cooperative Development Monthly Highest KPI'), 'pageSlug' => 'hrkpi.view'])
...
<div>
        ...
        <button><a href="{{ route('coopkpi.view') }}">Go back To KPI Analysis</a></button>
