        ...
        <div class="col-md-5 ml-auto">
            <div class="info-area info-horizontal mt-5">
                ...
                <div class="description">
                    <h3 class="info-title">{{ __('Connected') }}</h3>
                    <p class="description">
                        {{ __('Easily accessible over Internet.') }}
                    </p>
                </div>
            </div>
            <div class="info-area info-horizontal">
                ...
                <div class="description">
                    <h3 class="info-title">{{ __('Coded with famous Laravel Framework.') }}</h3>
                    <p class="description">
